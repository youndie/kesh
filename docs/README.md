...
- [x] [research-architecture](research/research-architecture.md) — verified facts, the deviations from the brief, decisions D-1…D-20, risks, the reference dataset

### Services (5)

- [x] [resp](services/resp.md) — the RESP2 parser and writer
- [x] [store](services/store.md) — the keyspace, strings, hashes and keys, lazy expiry; the other kinds *target*
