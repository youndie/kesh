...
#   arms: default | pmcs | single-mark | page256 | page16   (default is 256 KiB pages since D-19)
#
...
declare -A OPTION=([default]="" [pmcs]="gc=pmcs" [single-mark]="gcMarkSingleThreaded=true" [page256]="fixedBlockPageSize=256" [page16]="fixedBlockPageSize=16")
